...
<li class="nav-item dropdown">
    ...
    <ul style="background: linear-gradient(120deg, #1e3c72 0%, #2a5298 100%);" class="dropdown-menu dropdown-menu-end">
        ...
        <li>
            <a class="dropdown-item text-white" href="<?= ($_SESSION['role'] === 'admin' || $_SESSION['role'] === 'employer') ? '../employers/profile.php' : '../pages/profile.php' ?>">
        ...
        <?php if ($_SESSION['role'] === 'admin'): ?>
            <li><a class="dropdown-item text-white" href="../admin/admin.php"><i class="fas fa-tachometer-alt me-2"></i> Dashboard</a></li>
        <?php endif; ?>
