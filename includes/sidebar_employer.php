...
<div class="sidebar" id="sidebar">
    <div>
        <h2>Admin Panel</h2>
        <ul>
            <li><a href="dashboard.php" class="<?= (basename($_SERVER['PHP_SELF']) == 'employer.php') ? 'active' : '' ?>"><i class="fas fa-tachometer-alt"></i> Dashboard</a></li>
            <li><a href="/JOB/employers/job_list.php" class="<?= (basename($_SERVER['PHP_SELF']) == 'job_list.php') ? 'active' : '' ?>"><i class="fas fa-users"></i> My Jobs</a></li>
            <li><a href="/JOB/employers/user_list.php" class="<?= (basename($_SERVER['PHP_SELF']) == 'user_list.php') ? 'active' : '' ?>"><i class="fas fa-person-circle-question"></i> Applicants</a></li>
        </ul>
    </div>
</div>
